/**
 * ReconciliationResultResponse.java
 *
...
public class ReconciliationResultResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the resultIdentifier value for this ReconciliationResultResponse.
     * 
    ...
    /**
     * Sets the resultIdentifier value for this ReconciliationResultResponse.
     * 
    ...
    /**
     * Gets the responseCodes value for this ReconciliationResultResponse.
     * 
    ...
    /**
     * Sets the responseCodes value for this ReconciliationResultResponse.
     * 
     * @param responseCodes
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ReconciliationResultResponse)) return false;
        ReconciliationResultResponse other = (ReconciliationResultResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReconciliationResultResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:KyotoProtocol:RegistrySystem:ITL:Types:1.0:0.0", "ReconciliationResultResponse"));
