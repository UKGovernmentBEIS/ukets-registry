...
public class ReceiveTotalsRequest  implements java.io.Serializable {
    ...
    private uk.gov.ets.kp.webservices.shared.types.Total[] totals;
    ...
    public ReceiveTotalsRequest(
           ...
           uk.gov.ets.kp.webservices.shared.types.Total[] totals) {
           this.from = from;
           this.to = to;
     ...
     * @return totals
     */
    public uk.gov.ets.kp.webservices.shared.types.Total[] getTotals() {
        return totals;
    }
     ...
     * @param totals
     */
    public void setTotals(uk.gov.ets.kp.webservices.shared.types.Total[] totals) {
        this.totals = totals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReceiveTotalsRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:KyotoProtocol:RegistrySystem:ITL:Types:1.0:0.0", "ReceiveTotalsRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:KyotoProtocol:RegistrySystem:ITL:Types:1.0:0.0", "Total"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
