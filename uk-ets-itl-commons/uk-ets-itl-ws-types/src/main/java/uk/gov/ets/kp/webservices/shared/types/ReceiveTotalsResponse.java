...
public class ReceiveTotalsResponse  implements java.io.Serializable {
    private int resultIdentifier;

    private int[] responseCodes;

    public ReceiveTotalsResponse() {
    }
    ...
    /**
     * Gets the resultIdentifier value for this ReceiveTotalsResponse.
     * 
    ...
    /**
     * Sets the resultIdentifier value for this ReceiveTotalsResponse.
     * 
    ...
    /**
     * Gets the responseCodes value for this ReceiveTotalsResponse.
     * 
    ...
    /**
     * Sets the responseCodes value for this ReceiveTotalsResponse.
     * 
     * @param responseCodes
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ReceiveTotalsResponse)) return false;
        ReceiveTotalsResponse other = (ReceiveTotalsResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReceiveTotalsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:KyotoProtocol:RegistrySystem:ITL:Types:1.0:0.0", "ReceiveTotalsResponse"));
