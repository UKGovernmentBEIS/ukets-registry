...
public class ProvideTotalsResponse  implements java.io.Serializable {
    private int resultIdentifier;

    private int[] responseCodes;

    public ProvideTotalsResponse() {
    }
    ...
    /**
     * Gets the resultIdentifier value for this ProvideTotalsResponse.
     * 
    ...
    /**
     * Sets the resultIdentifier value for this ProvideTotalsResponse.
     * 
    ...
    /**
     * Gets the responseCodes value for this ProvideTotalsResponse.
     * 
    ...
    /**
     * Sets the responseCodes value for this ProvideTotalsResponse.
     * 
     * @param responseCodes
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ProvideTotalsResponse)) return false;
        ProvideTotalsResponse other = (ProvideTotalsResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProvideTotalsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:KyotoProtocol:RegistrySystem:ITL:Types:1.0:0.0", "ProvideTotalsResponse"));
