/**
 * InitiateReconciliationResponse.java
 *
...
public class InitiateReconciliationResponse  implements java.io.Serializable {
    private int resultIdentifier;

    private int[] responseCodes;

    public InitiateReconciliationResponse() {
    }
    ...
    /**
     * Gets the resultIdentifier value for this InitiateReconciliationResponse.
     * 
    ...
    /**
     * Sets the resultIdentifier value for this InitiateReconciliationResponse.
     * 
    ...
    /**
     * Gets the responseCodes value for this InitiateReconciliationResponse.
     * 
    ...
    /**
     * Sets the responseCodes value for this InitiateReconciliationResponse.
     * 
     * @param responseCodes
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InitiateReconciliationResponse)) return false;
        InitiateReconciliationResponse other = (InitiateReconciliationResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InitiateReconciliationResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:KyotoProtocol:RegistrySystem:ITL:Types:1.0:0.0", "InitiateReconciliationResponse"));
