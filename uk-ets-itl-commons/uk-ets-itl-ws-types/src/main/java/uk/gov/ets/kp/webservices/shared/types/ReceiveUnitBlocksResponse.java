/**
 * ReceiveUnitBlocksResponse.java
 *
...
public class ReceiveUnitBlocksResponse  implements java.io.Serializable {
    private int resultIdentifier;

    private int[] responseCodes;

    public ReceiveUnitBlocksResponse() {
    }
    ...
    /**
     * Gets the resultIdentifier value for this ReceiveUnitBlocksResponse.
     * 
    ...
    /**
     * Sets the resultIdentifier value for this ReceiveUnitBlocksResponse.
     * 
    ...
    /**
     * Gets the responseCodes value for this ReceiveUnitBlocksResponse.
     * 
    ...
    /**
     * Sets the responseCodes value for this ReceiveUnitBlocksResponse.
     * 
     * @param responseCodes
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ReceiveUnitBlocksResponse)) return false;
        ReceiveUnitBlocksResponse other = (ReceiveUnitBlocksResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReceiveUnitBlocksResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:KyotoProtocol:RegistrySystem:ITL:Types:1.0:0.0", "ReceiveUnitBlocksResponse"));
