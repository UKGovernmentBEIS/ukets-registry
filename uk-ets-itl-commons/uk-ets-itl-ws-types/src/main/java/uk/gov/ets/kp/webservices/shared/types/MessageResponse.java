...
public class MessageResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the resultIdentifier value for this MessageResponse.
     * 
    ...
    /**
     * Sets the resultIdentifier value for this MessageResponse.
     * 
    ...
    /**
     * Gets the responseCodes value for this MessageResponse.
     * 
    ...
    /**
     * Sets the responseCodes value for this MessageResponse.
     * 
     * @param responseCodes
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:KyotoProtocol:RegistrySystem:ITL:Types:1.0:0.0", "MessageResponse"));
