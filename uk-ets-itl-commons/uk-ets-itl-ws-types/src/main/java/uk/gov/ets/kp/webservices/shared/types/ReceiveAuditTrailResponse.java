/**
 * ReceiveAuditTrailResponse.java
 *
...
public class ReceiveAuditTrailResponse  implements java.io.Serializable {
    private int resultIdentifier;

    private int[] responseCodes;

    public ReceiveAuditTrailResponse() {
    }
    ...
    /**
     * Gets the resultIdentifier value for this ReceiveAuditTrailResponse.
     * 
    ...
    /**
     * Sets the resultIdentifier value for this ReceiveAuditTrailResponse.
     * 
    ...
    /**
     * Gets the responseCodes value for this ReceiveAuditTrailResponse.
     * 
    ...
    /**
     * Sets the responseCodes value for this ReceiveAuditTrailResponse.
     * 
     * @param responseCodes
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ReceiveAuditTrailResponse)) return false;
        ReceiveAuditTrailResponse other = (ReceiveAuditTrailResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReceiveAuditTrailResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:KyotoProtocol:RegistrySystem:ITL:Types:1.0:0.0", "ReceiveAuditTrailResponse"));
