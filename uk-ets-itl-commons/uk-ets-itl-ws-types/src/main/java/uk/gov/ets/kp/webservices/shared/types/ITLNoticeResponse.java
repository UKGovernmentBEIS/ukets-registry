...
public class ITLNoticeResponse  implements java.io.Serializable {
    private int resultIdentifier;

    private int[] responseCodes;

    public ITLNoticeResponse() {
    }
    ...
    /**
     * Gets the resultIdentifier value for this ITLNoticeResponse.
     * 
    ...
    /**
     * Sets the resultIdentifier value for this ITLNoticeResponse.
     * 
    ...
    /**
     * Gets the responseCodes value for this ITLNoticeResponse.
     * 
    ...
    /**
     * Sets the responseCodes value for this ITLNoticeResponse.
     * 
     * @param responseCodes
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ITLNoticeResponse)) return false;
        ITLNoticeResponse other = (ITLNoticeResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ITLNoticeResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:KyotoProtocol:RegistrySystem:ITL:Types:1.0:0.0", "ITLNoticeResponse"));
