/**
 * ProvideUnitBlocksResponse.java
 *
...
public class ProvideUnitBlocksResponse  implements java.io.Serializable {
    private int resultIdentifier;

    private int[] responseCodes;

    public ProvideUnitBlocksResponse() {
    }
    ...
    /**
     * Gets the resultIdentifier value for this ProvideUnitBlocksResponse.
     * 
    ...
    /**
     * Sets the resultIdentifier value for this ProvideUnitBlocksResponse.
     * 
    ...
    /**
     * Gets the responseCodes value for this ProvideUnitBlocksResponse.
     * 
    ...
    /**
     * Sets the responseCodes value for this ProvideUnitBlocksResponse.
     * 
     * @param responseCodes
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ProvideUnitBlocksResponse)) return false;
        ProvideUnitBlocksResponse other = (ProvideUnitBlocksResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProvideUnitBlocksResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:KyotoProtocol:RegistrySystem:ITL:Types:1.0:0.0", "ProvideUnitBlocksResponse"));
