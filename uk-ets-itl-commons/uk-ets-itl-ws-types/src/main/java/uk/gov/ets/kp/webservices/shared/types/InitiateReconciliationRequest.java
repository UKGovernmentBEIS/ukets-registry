...
public class InitiateReconciliationRequest  implements java.io.Serializable {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InitiateReconciliationRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:KyotoProtocol:RegistrySystem:ITL:Types:1.0:0.0", "InitiateReconciliationRequest"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("snapshotDatetime");
        elemField.setXmlName(new javax.xml.namespace.QName("", "snapshotDatetime"));
