...
public class ProposalTransaction  implements java.io.Serializable {
    ...
    private uk.gov.ets.lib.commons.kyoto.types.TransactionUnitBlock[] proposalUnitBlocks;
    ...
    public ProposalTransaction(
           ...
           uk.gov.ets.lib.commons.kyoto.types.TransactionUnitBlock[] proposalUnitBlocks) {
     ...
     */
    public uk.gov.ets.lib.commons.kyoto.types.TransactionUnitBlock[] getProposalUnitBlocks() {
        return proposalUnitBlocks;
    }
     ...
     */
    public void setProposalUnitBlocks(uk.gov.ets.lib.commons.kyoto.types.TransactionUnitBlock[] proposalUnitBlocks) {
        this.proposalUnitBlocks = proposalUnitBlocks;
    }
