...
CLIENT_FILE_PATH=migrations/migration_0035-add-account-recovery-api-client/uk-ets-realm-account-recovery-api.json
...
HTTP_CODE=$(
  ...
  "migration_0035-add-account-recovery-api-client/uk-ets-realm-account-recovery-api-realm-management-roles.json"
)
