...
TEMP_FILE_NAME="$BASE_FILE_PATH"/migrations/migration_0033-hashing-iterations-password-policy/uk-ets-realm-updated-policy-temp.json
...
if
  ...
  "$BASE_FILE_PATH"/migrations/migration_0033-hashing-iterations-password-policy/uk-ets-realm-updated-policy.json >${TEMP_FILE_NAME}
then
