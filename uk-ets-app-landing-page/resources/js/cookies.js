...
// moved from body onload to avoid inline scripts
window.onload = checkIfCookiesNotAccepted;

// move click handlers from html to avoid inline scripts
document.getElementById("acceptAllCookiesBtn").addEventListener("click", (e ) => acceptAllCookies());
document.getElementById("setPreferencesCookiesBtn").addEventListener("click", (e ) => goToSetPreferences());
document.getElementById("goToSetPreferencesBtn").addEventListener("click", (e ) => goToSetPreferences());
document.getElementById("hideCookieMsgBtn").addEventListener("click", (e ) => hideCookieMessage());
