...
import static gov.uk.ets.reports.api.security.SecurityHeaders.CSP_HEADER;
import static gov.uk.ets.reports.api.security.SecurityHeaders.FEATURE_POLICY_HEADER;
...
public class SecurityConfig extends KeycloakWebSecurityConfigurerAdapter {
    ...
    @Value("classpath:keycloak/uk-ets-reports-api-authz-config.json")
    ...
    public CommandLineRunner keycloakAuthorizationDataLoader(KeycloakSpringBootProperties properties,
        ...
        return new CommandLineRunner() {
            ...
            final Header header = new BasicHeader(HttpHeaders.USER_AGENT, "reports-api-initial-security-config");
