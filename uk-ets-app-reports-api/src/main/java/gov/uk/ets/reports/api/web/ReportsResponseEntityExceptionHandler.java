...
@ControllerAdvice
@Log4j2
public class ReportsResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    @Override
     ...
     */
    @ExceptionHandler(UkEtsReportsClientException.class)
    public ResponseEntity<ErrorBody> handleUkEtsReportsClientException(UkEtsReportsClientException exception) {
        ErrorBody error = ErrorBody.builder()
            .errorDetails(
                List.of(ErrorDetail.builder()
