...
public class ReportApiMessagingConfiguration {
    ...
    private String reportsApiTrustedPackages;
    ...
    private JsonDeserializer<ReportGenerationEvent> reportGenerationEventDeserializer() {
        try (JsonDeserializer<ReportGenerationEvent> deserializer =
                 new JsonDeserializer<>(ReportGenerationEvent.class, objectMapper)
                     .ignoreTypeHeaders()) {
            deserializer.addTrustedPackages(reportsApiTrustedPackages);
            return deserializer;
        }
    }
    ...
    private Map<String, Object> consumerConfigs() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, reportsApiConsumerGroupId);
        return props;
    }
