...
public abstract class AbstractTransactionProcessor extends AbstractUpdateProcessor {
    ...
    public SEFSubmission createSubmission(String registryCode) {
        ...
        sefSubmission.setTable1(RF1TableFactory.initializeTable1());
        sefSubmission.setTable2A(RF1TableFactory.initializeTable2A());
        sefSubmission.setTable2B(RF1TableFactory.initializeTable2B());
        sefSubmission.setTable2C(RF1TableFactory.initializeTable2C());
        sefSubmission.setTable3(RF1TableFactory.initializeTable3());
        sefSubmission.setTable4(RF1TableFactory.initializeTable4());
        sefSubmission.setTable5A(RF1TableFactory.initializeTable5A());
        sefSubmission.setTable5B(RF1TableFactory.initializeTable5B());
        sefSubmission.setTable5C(RF1TableFactory.initializeTable5C());
        sefSubmission.setTable6A(RF1TableFactory.createTable6A());
        sefSubmission.setTable6B(RF1TableFactory.createTable6B());
        sefSubmission.setTable6C(RF1TableFactory.createTable6C());
