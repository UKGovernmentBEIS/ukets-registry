...
@Log4j2
public class ComplianceReportJdbcMapper
    implements ReportDataMapper<ComplianceReportData>, RowMapper<ComplianceReportData> {
     ...
     *
     |cuttof_year|year|           account_type          |account_status|start_year|end_year|compliance_status|verified_emissions|verified_emissions_str|surrendered_emissions |
     |-----------|----|------------------------- --|------------------|-------------|---------------------------------|--------------|----------|--------|---------------|
     |    2021    |2021|AIRCRAFT_OPERATOR_HOLDING_ACCOUNT|      OPEN    |   2021   |  2021  |  NOT_APPLICABLE |        2         |        2             |        0             |
     |    2021    |2022|AIRCRAFT_OPERATOR_HOLDING_ACCOUNT|      OPEN    |   2021   |  2021  |  NOT_APPLICABLE |        0         |                      |                      |
     |    2021    |2023|AIRCRAFT_OPERATOR_HOLDING_ACCOUNT|      OPEN    |   2021   |  2021  |  NOT_APPLICABLE |        0         |                      |                      |
     |    2021    |2024|AIRCRAFT_OPERATOR_HOLDING_ACCOUNT|      OPEN    |   2021   |  2021  |  NOT_APPLICABLE |        0         |                      |                      |
     |    2021    |2025|AIRCRAFT_OPERATOR_HOLDING_ACCOUNT|      OPEN    |   2021   |  2021  |  NOT_APPLICABLE |        0         |                      |                      |
     *
    ...
    private static final String REPORT_QUERY = "select regulator,\n" +
        ...
        "                    when 'CLOSURE_PENDING' then 'CLOSED'\n" +        
        "                    else 'OPEN'\n" +
    ...
    @Override
    public List<ComplianceReportData> mapData(ReportCriteria criteria) {
        return List.of();
    }

    @Override
    public List<ComplianceReportData> mapData(ReportQueryInfoWithMetadata reportQueryInfo) {
    ...
    @Override
    public ComplianceReportData mapRow(ResultSet rs, int i) throws SQLException {
