...
public enum KyotoAccountType {
     ...
     */
    EXCESS_ISSUANCE_CANCELLATION_ACCOUNT(240),

    /**
     * CCS net reversal cancellation account.
     */
    CCS_NET_REVERSAL_CANCELLATION_ACCOUNT(241),

    /**
     * CCS non-submission of verification report cancellation account.
     */
    CCS_NON_SUBMISSION_OF_VERIFICATION_REPORT_CANCELLATION_ACCOUNT(242),
    ...
    /**
     * Administrative cancellation account.
     */
    ADMINISTRATIVE_CANCELLATION_ACCOUNT(260),
