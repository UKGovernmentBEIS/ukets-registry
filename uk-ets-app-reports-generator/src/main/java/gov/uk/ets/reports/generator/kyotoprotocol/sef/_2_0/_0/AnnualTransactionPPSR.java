...
@XmlRootElement(name = "AnnualTransactionPPSR")
public class AnnualTransactionPPSR {

    @XmlElement(name = "Additions", namespace = "urn:KyotoProtocol:RegistrySystem:SEF:1.0:0.0", required = true)
    protected Additions additions;
    @XmlElement(name = "Subtractions", namespace = "urn:KyotoProtocol:RegistrySystem:SEF:1.0:0.0", required = true)
