...
@Service
public class MOHAAllocationRAReportService implements ReportTypeService<MOHAAllocationRAReportData> {

    private final ReportDataMapper<MOHAAllocationRAReportData> mapper;

    @Override
    public ReportType reportType() {
        return ReportType.R0045;
    }

    @Override
    public List<Object> getReportDataRow(MOHAAllocationRAReportData reportData) {
    ...
    @Override
    public List<MOHAAllocationRAReportData> generateReportData(ReportQueryInfoWithMetadata reportQueryInfo) {
