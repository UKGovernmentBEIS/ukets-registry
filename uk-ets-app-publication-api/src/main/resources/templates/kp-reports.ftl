      ...
      <main class="govuk-main-wrapper">
        <div class="govuk-grid-row">
          <div class="govuk-grid-column-two-thirds">
            <h1 class="govuk-heading-l">Kyoto Protocol Public Reports</h1>
            <div class="govuk-body">
              For the purpose of meeting its obligations as a Party to the Kyoto
              Protocol, the UK must operate a Kyoto Protocol national registry.
            </div>
            <div class="govuk-body">
              The public information below is provided pursuant to paragraphs 44
              to 48 of the annex to Decision 13/CMP.l.
            </div>
            <hr
              class="
            ...
            <aside class="app-related-items" role="complementary">
              ...
              <nav role="navigation" aria-labelledby="subsection-title">
                <ul class="govuk-list govuk-!-font-size-16 govuk-list--spaced">
                  ...
                  <!-- 4. UK ETS Public Reports  -->
                  <li>
                    <a class="govuk-link govuk-!-font-size-19" href="ets-reports.html">
