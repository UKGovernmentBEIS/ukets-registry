...
Feature: Account management - Update AR request AR suspend
  ...
  @test-case-id-08066946510
  Scenario Outline: As admin I can Suspend update request submit of an AR to non CLOSED account
   ...
   # select Suspend and continue
    When I select the "Suspend representative" option
    And I click the "Continue" button
    Then I am presented with the "Account authorized representatives" screen
    And The page "contains" the "Suspend representative" text
    # try to continue without selection
    When I click the "Continue" button
    ...
    And The page "contains" the "Suspend authorised representative" text
  ...
  @sampling-smoke @test-case-id-08066946511
  Scenario: As admin I cannot Suspend update request submit of an AR to Transfer Pending account
    # create first account
    Given I have created an account with the following properties
      | property                 | value                      |
      | accountType              | OPERATOR_HOLDING_ACCOUNT   |
  ...
  @exec-manual @test-case-id-08066946591
  Scenario Outline: As admin I can approve AR Suspend request when I am NOT initiator and reject even I am initiator
    # create first account
    Given I have created an account with the following properties
      | property                 | value                      |
      | accountType              | OPERATOR_HOLDING_ACCOUNT   |
    ...
    And I have created the following tasks
      ...
      | 100000001  | <claimant> |        |         | AUTHORIZED_REPRESENTATIVE_SUSPEND_REQUEST | <initiator>  |              | auth rep:SUSPEND,UK977538690871 |
    Then I am presented with the "Registry dashboard" screen
    ...
    Examples:
      ...
      | senior admin | 100000004 | 100000005 | Approve     | approve           | APPROVED          | Authorised representatives Suspended representatives Name Access rights Work contact details Authorised Representative3 Initiate and approve transactions Email dont@care.com Phone number +UK (44)1434634996 more info Request update |
      ...
      | junior admin | 100000004 | 100000005 | Approve     | approve           | APPROVED          | Authorised representatives Suspended representatives Name Access rights Work contact details Authorised Representative3 Initiate and approve transactions Email dont@care.com Phone number +UK (44)1434634996 more info Request update |
  ...
  @sampling-smoke @test-case-id-08066946663
  Scenario Outline: As AR with correct access rights I cannot complete Suspend AR request when I am NOT initiator
   # create first account
    Given I have created an account with the following properties
      | property                 | value                      |
      | accountType              | OPERATOR_HOLDING_ACCOUNT   |
    ...
    And I have created the following tasks
      | account_id | claimed_by | status | outcome | type                                      | initiated_by | completed_by | diff                            |
      | 100000001  | 100000005  |        |         | AUTHORIZED_REPRESENTATIVE_SUSPEND_REQUEST | 100000005    |              | auth rep:SUSPEND,UK977538690871 |
    Then I am presented with the "Registry dashboard" screen
