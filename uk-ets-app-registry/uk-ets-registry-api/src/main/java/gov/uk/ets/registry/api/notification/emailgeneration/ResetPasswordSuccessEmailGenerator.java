...
import gov.uk.ets.registry.api.notification.ResetPasswordSuccessNotificationProperties;
...
public class ResetPasswordSuccessEmailGenerator extends EmailGenerator {
    private final ResetPasswordSuccessNotificationProperties properties;
    private final ResetPasswordSuccessNotification notification;
    private final Configuration freemarkerConfiguration;
    private final MailConfiguration mailConfiguration;

    private static final String TEMPLATE = "reset-password-success.ftl";
