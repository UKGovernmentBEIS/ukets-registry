...
public class EmailChangeConfirmationEmailGenerator extends EmailGenerator {
    private final EmailChangeConfirmationNotification notification;
    private final EmailChangeNotificationProperties properties;
    private final Configuration freemarkerConfiguration;
    private final MailConfiguration mailConfiguration;

    private static final String TEMPLATE = "email-change-confirm.ftl";

    @Override
    public Map<String, Object> params() {
        final Map<String, Object> params = new HashMap<>();
        params.put("etrAddress", mailConfiguration.getEtrAddress());
        params.put("url", notification.getConfirmationUrl());
    ...
    public GroupNotification generate() {
        this.subject(new EmailSentence(properties.getConfirmationSubject()));
