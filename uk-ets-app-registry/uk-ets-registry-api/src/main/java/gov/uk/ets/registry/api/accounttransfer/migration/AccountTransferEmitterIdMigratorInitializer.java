...
public class AccountTransferEmitterIdMigratorInitializer implements CommandLineRunner {

    private static final String SCHED_LOCK_NAME = "AccountTransferEmitterIdMigratorInitiator";

    private final AccountTransferEmitterIdMigrator migrator;
