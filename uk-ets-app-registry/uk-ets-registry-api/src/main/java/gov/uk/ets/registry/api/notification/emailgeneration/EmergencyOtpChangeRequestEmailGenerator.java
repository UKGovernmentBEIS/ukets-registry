...
public class EmergencyOtpChangeRequestEmailGenerator extends EmailGenerator {
    private final EmergencyOtpChangeRequestedNotification notification;
    private final NotificationProperties notificationProperties;
    private final Configuration freemarkerConfiguration;
    private final MailConfiguration mailConfiguration;

    private static final String TEMPLATE = "emergency-otp-change-request.ftl";
    ...
    public GroupNotification generate() {
        EmergencyChangeNotificationProperties properties = notificationProperties.getEmergencyOtpChange();
