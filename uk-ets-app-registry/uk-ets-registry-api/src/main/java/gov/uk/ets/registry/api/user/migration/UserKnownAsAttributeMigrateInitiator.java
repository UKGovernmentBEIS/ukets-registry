 ...
 * That is why a scheduled job is created (manually) so we can use shedlock functionality.
 */
@Component
@RequiredArgsConstructor
@ConditionalOnProperty(name = "keycloak.enabled", havingValue = "true")
@Profile("!integrationTest")
public class UserKnownAsAttributeMigrateInitiator implements CommandLineRunner {
    private static final String SCHED_LOCK_NAME = "UserKnownAsAttributeMigratorSchedulerLock";

    private final UserKnownAsAttributeMigrator migrator;
