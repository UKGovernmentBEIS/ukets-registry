...
@Log4j2
@KafkaListener(
    containerFactory = "maritimeEmissionsConsumerFactory",
    topics = "maritime-emissions-updated-request-topic"
)
...
public class MaritimeEmissionEventConsumer {
     ...
     * Default constructor.
     * 
     * @param emissionEventService
     * @param kafkaTemplate
     * @param util
     */
    public MaritimeEmissionEventConsumer(EmissionEventService emissionEventService,
                                         @Qualifier("maritimeEmissionsOutcomeKafkaTemplate") KafkaTemplate<String, 
                                         AccountEmissionsUpdateEventOutcome> kafkaTemplate,
    ...
    public void processEmissionEvent(AccountEmissionsUpdateEvent event, @Headers Map<String, Object> headers) {
        List<IntegrationEventError> errors = emissionEventService.process(event, headers, SourceSystem.MARITIME);
