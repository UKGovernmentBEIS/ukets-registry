...
@Service
public class AuthorisedRepresentativeRemoveTaskService extends AuthorisedRepresentativeUpdateTaskService {

    public AuthorisedRepresentativeRemoveTaskService(AccountService accountService,
    ...
    public Set<RequestType> appliesFor() {
        return Set.of(RequestType.AUTHORIZED_REPRESENTATIVE_REMOVAL_REQUEST);
    }
