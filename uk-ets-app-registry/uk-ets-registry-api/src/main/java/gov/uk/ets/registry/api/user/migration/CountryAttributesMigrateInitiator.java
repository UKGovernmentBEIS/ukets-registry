...
public class CountryAttributesMigrateInitiator implements CommandLineRunner {
    private static final String SCHED_LOCK_NAME = "CountryAttributesMigratorSchedulerLock";

    private final CountryAttributesMigrator migrator;
