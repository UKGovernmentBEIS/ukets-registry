...
/**
 * (AR) An update request cannot be submitted for accounts with status CLOSED or SUSPENDED or TRANSFER PENDING
 * or ALL_TRANSACTIONS_RESTRICTED or SOME_TRANSACTIONS_RESTRICTED or PARTIALLY SUSPENDED.
 */
public class ARsCanSubmitTalUpdateWhenAccountHasSpecificStatus extends AbstractBusinessRule {

    public ARsCanSubmitTalUpdateWhenAccountHasSpecificStatus(
    ...
    public ErrorBody error() {
        return ErrorBody
            .from("(AR) An update request cannot be submitted for accounts with status CLOSED or CLOSURE_PENDING or SUSPENDED " +
