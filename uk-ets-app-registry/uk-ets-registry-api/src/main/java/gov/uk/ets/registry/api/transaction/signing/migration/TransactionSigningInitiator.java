...
public class TransactionSigningInitiator implements CommandLineRunner {

    private static final String SCHED_LOCK_NAME = "TransactionSigningSchedulerLock";
  
    private final TransactionSigningMigrator migrator;
