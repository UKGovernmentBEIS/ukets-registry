...
public class EmailChangeRequestedEmailGenerator extends EmailGenerator {
    private final EmailChangeNotificationProperties properties;
    private final EmailChangeRequestedNotification notification;
    private final Configuration freemarkerConfiguration;
    private final MailConfiguration mailConfiguration;

    private static final String TEMPLATE = "email-change-request.ftl";
