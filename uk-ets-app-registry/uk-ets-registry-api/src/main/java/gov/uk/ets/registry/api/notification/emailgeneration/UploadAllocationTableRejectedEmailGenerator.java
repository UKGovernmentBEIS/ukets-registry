...
public class UploadAllocationTableRejectedEmailGenerator extends EmailGenerator {
    ...
    private static final String TEMPLATE = "upload-allocation-table-reject.ftl";
