...
public class UploadAllocationTableApprovedEmailGenerator extends EmailGenerator {
    ...
    private static final String TEMPLATE = "upload-allocation-table-approve.ftl";
