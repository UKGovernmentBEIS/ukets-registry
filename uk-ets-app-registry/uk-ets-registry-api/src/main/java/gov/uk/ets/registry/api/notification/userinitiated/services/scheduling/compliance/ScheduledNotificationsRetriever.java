...
class ScheduledNotificationsRetriever {

    private final NotificationSchedulingRepository schedulingRepository;

    List<Notification> getNotificationsToBeSent() {
        return schedulingRepository.getActiveNotifications(NotificationType.getComplianceNotificationTypes())
            .stream()
