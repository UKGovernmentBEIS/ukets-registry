...
import static gov.uk.ets.registry.api.config.SecurityHeaders.CSP_HEADER;
import static gov.uk.ets.registry.api.config.SecurityHeaders.FEATURE_POLICY_HEADER;
...
public class SecurityConfig extends KeycloakWebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.headers()
            ...
            .and()
            .featurePolicy(FEATURE_POLICY_HEADER)
            .and()
            ...
            .frameOptions()
            .sameOrigin() // without this there is an error concerning the cookies iframe (specifically this header is set to DENY)
        ;
    }
    ...
    @Bean
    public CommandLineRunner keycloakAuthorizationDataLoader(
        KeycloakSpringBootProperties properties, ObjectMapper mapper) {
