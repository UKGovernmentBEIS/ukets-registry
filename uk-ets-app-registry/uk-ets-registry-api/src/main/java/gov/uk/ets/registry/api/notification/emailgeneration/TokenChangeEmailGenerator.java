...
import gov.uk.ets.registry.api.notification.TokenChangeNotificationProperties;
...
public class TokenChangeEmailGenerator extends EmailGenerator {
    private final TokenChangeNotification notification;
    private final TokenChangeNotificationProperties properties;
    private final Configuration freemarkerConfiguration;
    private final MailConfiguration mailConfiguration;

    private static final String TEMPLATE = "token-change.ftl";
