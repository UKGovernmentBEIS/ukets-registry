...
public class AccountHolderController {
    ...
    public ResponseEntity<List<AccountHolderTypeAheadSearchResultDTO>> getAccountHoldersByNameOrIdentifier(@RequestParam String name,
                                                                                         @RequestParam
                                                                                             AccountHolderType type) {
        final List<AccountHolderTypeAheadSearchResultDTO> accountHolders =
                accountHolderService.getAllAccountHoldersByNameAndIdentifier(name, type);

        return new ResponseEntity<>(accountHolders, HttpStatus.OK);
    }
