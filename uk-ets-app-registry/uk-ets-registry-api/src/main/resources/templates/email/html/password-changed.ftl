...
<head></head>
<body>
<p>Your UK Registry password has been changed.</p>
<p>Remember to use your new password the next time you want to sign in to the UK Registry.</p>
<p>If you did not request this reset you must <a href="mailto: ${etrAddress}">contact the UK Registry Helpdesk</a>.</p>
