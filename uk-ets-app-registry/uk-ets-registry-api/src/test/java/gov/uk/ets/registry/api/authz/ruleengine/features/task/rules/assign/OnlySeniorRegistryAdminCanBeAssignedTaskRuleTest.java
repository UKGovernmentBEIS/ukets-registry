...
class OnlySeniorRegistryAdminCanBeAssignedTaskRuleTest {
    ...
    @Test
    void error() {
        ErrorBody errorBody = new OnlySeniorRegistryAdminCanBeAssignedTaskRule(securityStore).error();
    ...
    void permit() {
        ...
        OnlySeniorRegistryAdminCanBeAssignedTaskRule rule = new OnlySeniorRegistryAdminCanBeAssignedTaskRule(securityStore);
        ...
        securityStore.setTaskBusinessSecurityStoreSlice(slice);
        rule = new OnlySeniorRegistryAdminCanBeAssignedTaskRule(securityStore);
