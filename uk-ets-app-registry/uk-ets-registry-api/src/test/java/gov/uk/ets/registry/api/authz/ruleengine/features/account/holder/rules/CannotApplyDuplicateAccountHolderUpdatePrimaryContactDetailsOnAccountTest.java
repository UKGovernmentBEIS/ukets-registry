...
class CannotApplyDuplicateAccountHolderUpdatePrimaryContactDetailsOnAccountTest {
    @Mock
    ...
    void permit() {
        ...
        t.setType(RequestType.ACCOUNT_HOLDER_PRIMARY_CONTACT_DETAILS);
        ...
        CannotApplyDuplicateAccountHolderUpdatePrimaryContactDetailsOnAccount rule =
                new CannotApplyDuplicateAccountHolderUpdatePrimaryContactDetailsOnAccount(businessSecurityStore);
        // when
