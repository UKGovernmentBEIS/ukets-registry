...
class OnlySeniorOrJuniorCanClaimTaskRuleTest {
    @Mock
    private User user;
    ...
    @Test
    void error() {
        ErrorBody errorBody = new OnlySeniorOrJuniorCanClaimTaskRule(securityStore).error();
    ...
    void permit() {
        ...
        OnlySeniorOrJuniorCanClaimTaskRule rule = new OnlySeniorOrJuniorCanClaimTaskRule(securityStore);
        ...
        rule = new OnlySeniorOrJuniorCanClaimTaskRule(securityStore);
