...
class CanBeCompletedByEnrolledAROrSeniorRegistryAdminRuleTest {
    @Mock
    private User user;
    ...
    @Test
    void error() {
        ErrorBody errorBody = new CanBeCompletedByEnrolledAROrSeniorRegistryAdminRule(securityStore).error();
    ...
    void permit() {
        ...
        CanBeCompletedByEnrolledAROrSeniorRegistryAdminRule rule = new CanBeCompletedByEnrolledAROrSeniorRegistryAdminRule(securityStore);
        ...
        rule = new CanBeCompletedByEnrolledAROrSeniorRegistryAdminRule(securityStore);
