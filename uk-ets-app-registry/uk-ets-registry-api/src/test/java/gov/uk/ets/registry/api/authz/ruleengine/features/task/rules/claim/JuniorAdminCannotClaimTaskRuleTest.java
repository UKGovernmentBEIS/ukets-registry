...
class JuniorAdminCannotClaimTaskRuleTest {
    ...
    void permit() {
        ...
        JuniorAdminCannotClaimTaskRule rule = new JuniorAdminCannotClaimTaskRule(securityStore);
        ...
        rule = new JuniorAdminCannotClaimTaskRule(securityStore);
