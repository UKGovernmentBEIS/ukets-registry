...
class MetsContactsEventValidatorTest {
    ...
    void setUp() {
        ...
        validator = new MetsContactsEventValidator(commonValidator, phoneNumberValidator, accountService);
    }
    ...
    private MetsContactsMessage validMessage() {
        ...
        msg.setTelephoneNumber("2070313000");
    ...
    @Test
    void testUxTelephoneCountryCode() throws AccountStatusValidationException {
        String ref = "Telephone country code";
        MetsContactsMessage msg = validMessage();
        msg.setTelephoneCountryCode("UX");
    ...
    @Test
    void test0044UxTelephoneCountryCode() throws AccountStatusValidationException {
        String ref = "Telephone country code";
        MetsContactsMessage msg = validMessage();
        msg.setTelephoneCountryCode("0044 (Ux)");
    ...
    void testTelephoneNumberMandatoryAndInvalidCharsAndCharsLimit() throws AccountStatusValidationException {
        ...
        List<IntegrationEventErrorDetails> errors2 =
                validator.validate(buildEvent(msg2), OPERATOR_TYPE);
        assertTrue(
                containsError(errors2, IntegrationEventError.ERROR_0701,
        ...
        assertTrue(
                containsError(errors3, IntegrationEventError.ERROR_0701,
                        "Invalid Phone Country Code and Phone number combination"),
    ...
    void testUxTelephoneCountryCode_shouldReturn0701() throws AccountStatusValidationException {
        ...
        assertTrue(
                containsError(errors, IntegrationEventError.ERROR_0701, ref),
                "Expected ERROR_0701 for invalid telephone country code"
        );
    }


    @Test
    void testMobilePhoneCountryCodeExistsButNumberMissing_shouldReturn0702ForMobileNumber()
            throws AccountStatusValidationException {
        ...
        assertTrue(
                containsError(errors, IntegrationEventError.ERROR_0702, "Mobile number"),
                "Expected ERROR_0702 because mobile number is mandatory when country code is provided"
        );
    }
