...
class PaymentIntegrationMapperTest {
    ...
    void setUp() {
        ...
        paymentTaskCompleteResponseFactory = new PaymentTaskCompleteResponseFactory();
    ...
    void paymentToPaidPaymentDTO_shouldMapAllFields() {
        ...
        payment.setReferenceNumber(987654L);
        ...
        assertEquals(987654L, dto.getReferenceNumber());
