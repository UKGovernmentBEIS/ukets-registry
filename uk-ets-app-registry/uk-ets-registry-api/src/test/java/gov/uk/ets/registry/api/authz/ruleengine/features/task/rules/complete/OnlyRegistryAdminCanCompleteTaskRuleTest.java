...
public class OnlyRegistryAdminCanCompleteTaskRuleTest {
    ...
    @Test
    void error() {
        ErrorBody errorBody = new OnlyRegistryAdminCanCompleteTaskRule(securityStore).error();
    ...
    void permit() {
        ...
        OnlyRegistryAdminCanCompleteTaskRule rule = new OnlyRegistryAdminCanCompleteTaskRule(securityStore);
        ...
        rule = new OnlyRegistryAdminCanCompleteTaskRule(securityStore);
        assertEquals(BusinessRule.Result.FORBIDDEN, rule.permit().getResult());
