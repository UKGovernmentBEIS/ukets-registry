...
class CheckAcquiringAccountForCentralTransfersFromAllocationAccountTest {

    @Mock
    TransactionAccountService transactionAccountService;
    @InjectMocks
    private CheckAcquiringAccountForCentralTransfersFromAllocationAccount
        checkAcquiringAccountForCentralTransfersFromAllocationAccount;
    ...
    void testForAcquiringTotalQuantityAccount() {
        ...
        checkAcquiringAccountForCentralTransfersFromAllocationAccount.execute(context);
    ...
    @Test
    @DisplayName("Test for allowed acquiring accounts: New Entrants Reserve Account")
    void testForAcquiringAllocationAccount() {
        ...
        Mockito.when(transactionAccountService.populateTransferringAccount(any())).thenReturn(
            AccountSummary
                .parse("UK-100-1013-0-32", RegistryAccountType.UK_ALLOCATION_ACCOUNT, AccountStatus.OPEN)
        );
