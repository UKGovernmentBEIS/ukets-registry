...
export class KnowsTheTokenChangeVerificationPage extends KnowsThePage {
  constructor() {
    super();
    this.name = RegistryScreen.TOKEN_CHANGE_VERIFICATION;
    this.setUpTestData();
    this.setUpLocators();
  }
  ...
  setUpLocators() {
    ...
    this.locators.set(
      ...
      new UserFriendlyLocator(
        'xpath',
        `//*[contains(text(),'Back to My Profile')]`
      )
    );
  }
