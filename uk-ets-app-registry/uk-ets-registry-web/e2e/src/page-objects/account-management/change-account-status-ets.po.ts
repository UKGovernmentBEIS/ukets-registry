...
export class KnowsTheChangeAccountStatusEtsPage extends KnowsThePage {
  constructor() {
    super();
    this.name = RegistryScreen.CHANGE_ACCOUNT_STATUS_ETS;
    this.setUpTestData();
    this.setUpLocators();
  }
  ...
  setUpLocators() {
    ...
    this.locators.set(
      'Continue',
      new UserFriendlyLocator('xpath', `//*[.=' Continue ']`)
    );
