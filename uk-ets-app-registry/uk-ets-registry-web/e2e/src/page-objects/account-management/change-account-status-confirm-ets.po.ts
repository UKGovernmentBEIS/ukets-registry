...
export class KnowsTheChangeAccountStatusConfirmEtsPage extends KnowsThePage {
  constructor() {
    super();
    this.name = RegistryScreen.CHANGE_ACCOUNT_STATUS_CONFIRM_ETS;
    this.setUpTestData();
    this.setUpLocators();
  }
  ...
  setUpLocators() {
    ...
    this.locators.set(
      ...
      new UserFriendlyLocator(
        'xpath',
        `//*[@id="main-content"]/div[2]/div/app-account-wizards-container/app-confirm-account-status-action-container/app-confirm-account-status-action/form/dl`
      )
    );
    this.locators.set(
    ...
    this.locators.set(
      ...
      new UserFriendlyLocator(
        'xpath',
        `//*[@id="main-content"]/app-account-header/div/div/div/div/dl/div[3]`
      )
    );
    this.locators.set(
      'Back',
