 ...
 */
export function createTransactionListErrorMap() {
  ...
  errorMap.set(
    ...
    new ErrorDetail(
      null,
      '500 Server error on fetching the transactions results'
    )
  );
  errorMap.set(
    'other',
    new ErrorDetail(
      null,
      'Unexpected error on fetching the transactions results'
    )
  );
