...
@Component({
  selector: 'app-update-recovery-phone-form-container',
  template: `
    <app-update-recovery-phone-form
      [state]="state$ | async"
...
export class UpdateRecoveryPhoneFormContainerComponent {
  ...
  onSubmitRequest(request: UpdateRecoveryPhoneRequest) {
    this.store.dispatch(
