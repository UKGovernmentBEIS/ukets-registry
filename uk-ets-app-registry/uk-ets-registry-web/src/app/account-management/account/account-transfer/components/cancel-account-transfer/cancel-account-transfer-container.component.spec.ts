...
describe('CancelAccountTransferContainerComponent', () => {
  let component: CancelAccountTransferContainerComponent;
  let fixture: ComponentFixture<CancelAccountTransferContainerComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CancelAccountTransferContainerComponent);
