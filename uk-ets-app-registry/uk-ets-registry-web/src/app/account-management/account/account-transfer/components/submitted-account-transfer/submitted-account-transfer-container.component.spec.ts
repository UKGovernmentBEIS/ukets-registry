...
describe('SubmittedAccountTransferContainerComponent', () => {
  let component: SubmittedAccountTransferContainerComponent;
  let fixture: ComponentFixture<SubmittedAccountTransferContainerComponent>;
