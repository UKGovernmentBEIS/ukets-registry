...
describe('AcquiringPrimaryContactDetailsContainerComponent', () => {
  let component: AcquiringPrimaryContactDetailsContainerComponent;
  let fixture: ComponentFixture<AcquiringPrimaryContactDetailsContainerComponent>;
